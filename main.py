...
argparser.add_argument(
    ...
    dest="phone_number",
    type=str,
    help="Your phone number associated with Telegram account",
)
argparser.add_argument(
    "-l",
    "--list",
    dest="action_list",
    help="List channels you subscribed",
    action="store_true",
)
...
def get_api_credentials():
    ...
    if os.path.exists(config_file):
        ...
        print(
            "To use this script, you need to obtain your own Telegram API ID and API Hash."
        )
        print(
...
if not phone_number:
    phone_number = input(
        "Enter your phone number (in international format, e.g., +123456789): "
    )
